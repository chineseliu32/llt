<template>
	<view class="container">
		...
		<view class="step" v-show="intStep==1">
			...
			<view class="ui-list">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">机构名称：</text>
			...
			<view class="ui-list">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">服务项目：</text>
				<input type="text" :placeholder="value2" name="serverName"   placeholder-class="place" />
			</view>
			<view class="ui-list right city">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">服务领域：</text>
			...
			<view class="ui-list right city">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">服务区域：</text>
			...
			<view class="city-box">
				...
				<view class="ui-list right">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">交易币种：</text>
				...
				<view class="ui-list ">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">收费报价<text class="thrr">(万元)</text>：</text>
					<input type="text" :placeholder="value2" name="priceSheet"  placeholder-class="place" />
				</view>
				<view class="ui-list right">
					<text class="two"></text>
			...
			<view class="ui-list">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">机构简介<text class="thrr">(500字以内)</text></text>
				<textarea  maxlength="300" name='projectContentsDesc' placeholder="填写服务机构的简要介绍" ></textarea>
			</view>
			</view>
			<!-- step 3-->
			<view class="step" v-show="intStep==3">
				...
				<view class="ui-list right">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">委托分类：</text>
...
<script>
	...
	import {fuwutigong,shailist,shaixuan,uploadFiles,categoryList,allUserEnum,getUserInfo,saveOrUpdateUserInfo,allProjectEnum,projectFinancingLoan} from "@/api/user.js";
		...
		console.log(uploadFiles)
		   uni.uploadFile({
			...
			isPoneAvailable(poneInput) {
				...
				console.log(/^1[3456789]d{9}$/.test(poneInput))
			},
			async toRegister(e){
				console.log(e);
				...
				this.get(fuwutigong, {
					...
					serverField:this.hangyeId,//服务行业分类id
