<template>
	<view class="ttttt">
		...
		<view class="conter">
			...
			<!-- 循环列表 -->
			<view class="none" v-for="(item,index) in indexlist" :key="index"  @click="xiang(item.id)" style="margin-top: 100upx;" >
				<view class="cone">
					<view class="left">
...
<script>
	...
	import {projectFinancingLoangetPageListApi ,allUserEnum,shaixuan,shailist,hangyeId,investList} from "@/api/user.js";
