<template>
	...
	<view class="ui-list">
			...
			<view class="ui-list">
				...
				<input type="text" :placeholder="value2" name="organizationName"  @input="bindprojectName" placeholder-class="place" />
			</view>
			...
			<view class="ui-list right">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">采购方性质：</text>
			...
			<view class="ui-list right city">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">采购领域：</text>
			...
			<view class="city-box">
				...
				<view class="ui-list ">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">采购报价<text class="thrr">(万元)</text>：</text>
					<input type="number" :placeholder="value2" name="purchasePrice"  placeholder-class="place" />
				</view>
				<view class="ui-list right">
					<text class="two"></text>
			...
			<view class="ui-list">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">采购方简介<text class="thrr">(300字以内)</text></text>
				<textarea  maxlength="300" name='organizationDesc' placeholder="填写采购主体的简要介绍" ></textarea>
			</view>
			</view>
			<!-- step 1-->
			<view class="step" v-show="intStep==3">
				<view>
					...
					:deleteUrl="$uploadUrl" :uploadCount="10"
					@successImage="successImage1" class="one"
					></easy-upload>
				</view>	
				<view class="ui-list right">
					<text class="two"></text>
...
<script>
	...
	import {serviceProcurement,shailist,shaixuan,uploadFiles,categoryList,allUserEnum,getUserInfo,saveOrUpdateUserInfo,allProjectEnum,projectFinancingLoan} from "@/api/user.js";
		...
		console.log(filePath)
		   uni.uploadFile({
			...
			if(this.dindex==1){
				...
				const rule = [
					{name:"organizationName", checkType : "string", checkRule:"2,20",  errorMsg:"主体名称最少为2个字符"},
				...
				this.get(serviceProcurement, {
					...
					professionalField:this.hangyeId,//服务行业分类id
