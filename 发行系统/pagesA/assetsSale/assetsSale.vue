	...
	<view class="container">
		...
		<view class="ui-all">
			...
			<view class="step" v-show="intStep==1">
				...
				<view class="ui-list">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">挂牌资产名称：</text>
					<input type="text" :placeholder="value2" name="projectName"  @input="bindprojectName" placeholder-class="place" />
				</view>
			...
			<view class="step" v-show="intStep==2">
				<view class="ui-list right">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">资产归属：</text>
				...
				<view class="ui-list right city">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">资产分类：</text>
					...
					<lb-picker @confirm="xzhangye" :list="leixinlist" :mode="selector" :level="level"><view class="cityname">{{hangyename}}</view></lb-picker>
				</view>
				<view class="ui-list right city">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">资产区域：</text>
				...
				<view class="ui-list ">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">挂牌资产数量<text class="thrr">(万元)</text>：</text>
					<input type="number" :placeholder="value2" name="projectCount"  placeholder-class="place" />
				</view>
					<view class="ui-list right">
						<text class="two"></text>
						<text style="color: #FF0000;">*</text><text class="one">报价币种：</text>
					...
					<view class="ui-list ">
						<text class="two"></text>
						<text style="color: #FF0000;">*</text><text class="one">出售报价<text class="thrr">(万元)</text>：</text>
						<input type="number" :placeholder="value2" name="sellPrice"  placeholder-class="place" />
					</view>
					<view class="ui-list right">
						<text class="two"></text>
			...
			<view class="ui-list">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">项目简介<text class="thrr">(1000字以内)</text></text>
				<textarea  maxlength="1000" name='projectContents' placeholder="填写出售资产的简要介绍" ></textarea>
			</view>
				...
				<view class="ui-list">
					...
					<input type="text" :placeholder="value2" :value="mobile" name="venturePartner" @input="bindmobile" placeholder-class="place" />
				</view>
				<view class="ui-list right">
					<text class="two"></text>
...
<script>
	...
	import {zichanchushou,shailist,shaixuan,uploadFiles,categoryList,allUserEnum,getUserInfo,saveOrUpdateUserInfo,allProjectEnum,projectFinancingLoan} from "@/api/user.js";
		...
		console.log(filePath)
		   uni.uploadFile({
			...
			if(this.dindex==1){
				...
				this.get(zichanchushou, {
					...data,
					...formData,
					projectLogoUrl:logourl,
					managingPartner :uni.getStorageSync("userNum").userPhone,
					propertyCurrency:this.index3+1,//币种financingCurrency
					id : this.myid,
					projectLabel:this.label,//标签
					propertyType:this.hangyeId,//行业id
					propertyVest: this.index+1,//企业或个人
