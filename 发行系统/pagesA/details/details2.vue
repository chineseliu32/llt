	...
	<view class="ttttt">
		...
		<view class="conter" v-if="datainfo!=null">
			...
			<view class="introduction">
				...
				<view class="quota">
					...
					<view class="q2" v-if="datainfo.subject_nature==1">
						企业
					</view>
					<view class="q2" v-if="datainfo.subject_nature==2">
						个人
					</view>
				</view>
				<view class="quota">
			...
			<view class="foot">
				<view class="quota">
					...
					<view class="q2" v-if="datainfo.financing_currency ==1">
						人民币
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==2">
						美元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==3">
						欧元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==4">
						英镑
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==5">
						加元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==6">
						欧元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==7">
						澳元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==8">
						日元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==9">
						新西兰元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==10">
						澳门元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==11">
						俄罗斯卢布
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==12">
						印度卢比
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==13">
						韩元
					</view>
					<view class="q2" v-if="datainfo.financing_currency ==14">
						瑞士法郎
					</view>
				</view>
				<view class="quota">
		...
		<view class="bbb" v-show="show" @click="show=false">
			<view class="buy">
				...
				<view class="text">
					您已成功申请参与
					<text class="textc">"{{datainfo.organization_name}}"</text>
					的投资,管理员将进行审核,审核通过将会与您联系的合作，该项目的管理合伙人会收到您的合作信息，会与您的专属管理合伙人联系，或者您也可通过您的专属管理合伙人联系该项目的管理合伙人，沟通推进项目合作。
				</view>
	...
	export default {
		...
		methods: {
			...
			async getinfo(id) {
				...
				console.log(res);
				let data = res.result.professionalFieldTreeList["6"]
				let ress = await this.get(fuwucaigouCon, {
					id: id,
				...
				if (ress.code == 0) {
					...
					let arr = ress.result.professional_field.split(',');
					data.forEach(item => {
						arr.forEach(it => {
							if (item.id == it) {
