<template>
	<view class="container">
		...
		<view class="step" v-show="intStep==1">
			...
			<view class="ui-list">
				<text class="two"></text>
				<text style="color: #FF0000;">*</text><text class="one">资产名称：</text>
			...
			<view class="city-box">
				...
				<view class="ui-list right">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">购买币种：</text>
				...
				<view class="ui-list ">
					<text class="two"></text>
					<text style="color: #FF0000;">*</text><text class="one">购买报价<text class="thrr">(万元)</text>：</text>
					<input type="number" :placeholder="value2" name="saleLimit"  placeholder-class="place" />
				</view>
			...
			<view class="ui-list">
				<text class="two"></text>
				<text class="one">特殊说明<text class="thrr">(1000字以内)</text></text>
				<textarea  maxlength="1000" name='specialDesc' placeholder="填写相关特殊说明和要求" ></textarea>
			</view>
			</view>
			<!-- step 3-->
...
<script>
	...
	import {zichangoumai,shailist,shaixuan,uploadFiles,categoryList,allUserEnum,getUserInfo,saveOrUpdateUserInfo,allProjectEnum,projectFinancingLoan} from "@/api/user.js";
