...
function getWebGlExtensions(_a) {
    ...
    if (extensions) {
        for (var _d = 0, extensions_1 = extensions; _d < extensions_1.length; _d++) {
            ...
            if (name_1 === polygonModeExtensionName || (name_1 === rendererInfoExtensionName && shouldAvoidDebugRendererInfo())) {
                continue;
            }
            ...
            if (name_1 === 'WEBGL_polygon_mode') {
                console.log(getConstantsFromPrototype(extension));
            }
