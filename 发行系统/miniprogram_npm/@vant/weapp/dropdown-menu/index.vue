<template>
<uni-shadow-root class="@vant-weapp-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom">
...
global['__wxRoute'] = '@vant/weapp/dropdown-menu/index'
