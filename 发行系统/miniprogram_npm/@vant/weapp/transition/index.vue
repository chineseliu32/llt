<template>
<uni-shadow-root class="@vant-weapp-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/transition/index'
...
export default global['__wxComponents']['@vant/weapp/transition/index']
</script>
