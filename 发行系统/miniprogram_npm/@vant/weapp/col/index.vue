<template>
<uni-shadow-root class="@vant-weapp-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="computed.rootStyle({ gutter })">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/col/index'
...
export default global['__wxComponents']['@vant/weapp/col/index']
</script>
