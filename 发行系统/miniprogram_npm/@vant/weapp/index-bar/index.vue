<template>
<uni-shadow-root class="@vant-weapp-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/index-bar/index'
...
export default global['__wxComponents']['@vant/weapp/index-bar/index']
</script>
