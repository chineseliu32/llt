...
@font-face {
	...
	font-style: normal;
	font-display: auto;
	src: url(https://img01.yzcdn.cn/vant/vant-icon-f463a9.woff2) format("woff2"), url(https://img01.yzcdn.cn/vant/vant-icon-f463a9.woff) format("woff"), url(https://img01.yzcdn.cn/vant/vant-icon-f463a9.ttf) format("truetype")
}
