<template>
<uni-shadow-root class="@vant-weapp-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
  ...
  <input :type="integer ? 'number' : 'digit'" :class="'input-class '+(utils.bem('stepper__input', { disabled: disabled || disableInput }))" :style="computed.inputStyle({ buttonSize, inputWidth })" :value="currentValue" :adjust-position="adjustPosition" :focus="focus" :disabled="disabled || disableInput" @input="onInput" @focus="onFocus" @blur="onBlur"></input>
