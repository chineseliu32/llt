<template>
<uni-shadow-root class="@vant-weapp-divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/divider/index'
...
export default global['__wxComponents']['@vant/weapp/divider/index']
</script>
