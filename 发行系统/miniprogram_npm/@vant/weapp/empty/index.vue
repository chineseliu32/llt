<template>
<uni-shadow-root class="@vant-weapp-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = '@vant/weapp/empty/index'
...
export default global['__wxComponents']['@vant/weapp/empty/index']
</script>
