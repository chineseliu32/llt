...
<script>
	...
	import {loginByPass, loginBySmsCode, smsCode, updatePassword,saveOrUpdateUserInfo,saveOrUpdateUserPassword} from "../../api/login";
	...
	export default{
		...
		methods: {
			...
			async toUpdatePassword(e){
				...
				const rule = [
					{name:"userPhone", checkType : "phoneno", checkRule:"11,11",  errorMsg:"请输入正确的手机号"},
				...
				/*  #endif  */
				this.$get(saveOrUpdateUserPassword, {
					...params,
					...formData,
