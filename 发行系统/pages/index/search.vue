	...
	export default {
		...
		methods: {
			...
			doSearch(key) {
				...
				this.$api.msg(key);
				uni.navigateTo({
					url: `/pages/project/project?keyword=${key}`
				})
			},
			//保存关键字到历史记录
			saveKeyword(keyword) {
...
<style lang="scss">
	view{display:block;}
	.search-box {width:100%;background-color:rgb(242,242,242);padding:15upx 20upx; display:flex;justify-content:space-between;}
	.search-box .mSearch-input-box{width: 100%; padding-right: 40upx;}
