<template>
	<view class="content">
		...
		<view :nameqqq="name" :change:nameqqq="f2.update" :sumAmountOne="sumAmountOne" :change:sumAmountOne="f2.update" :data="data" :change:data="f2.update"
		:data2="data2" :change:data2="f2.update" :sumAmountTwo="sumAmountTwo" :change:sumAmountTwo="f2.update" :category2="category2" :change:category2="f2.update"
		:data3="data3" :change:data3="f2.update" :sumAmountThree="sumAmountThree" :change:sumAmountThree="f2.update" :category3="category3" :change:category3="f2.update"
		></view>
...
<script>
	...
	created(){
		 this.getTotalMoney_Week();
		 //this.getNewUser_Month();  
	},
		mounted() {

			this.$get(`${getTotalMoney_Week}`, {
	...
	export default {
		...
		methods: {
			...
			initF2() {
				...
				var option = {
					title: {
						text: "申购金额总计:￥"+this.sumAmountThree,
						textStyle: {
							color: '#55aaff', // 文字的颜色
							fontStyle: 'normal', // 文字字体的风格（'normal'，无样式；'italic'，斜体；'oblique'，倾斜字体） 
							fontWeight: 'normal', // 文字字体的粗细（'normal'，无样式；'bold'，加粗；'bolder'，加粗的基础上再加粗；'lighter'，变细；数字定义粗细也可以，取值范围100至700）
