<template>
	<view class="ttttt">
		...
		bottom: 0;" src="../../static/image/textbj.png" alt="" />
			...
			<input style="margin-left: 10px; 10px;width: 200px;  border-bottom:solid;border-width: 1upx; " type="number"
				placeholder="发布数量" name="buyCount" v-model="buyCount" disabled="true" @input="buyCount" placeholder-class="place" />
		</view>
		<view class="zuopin">
			<p class="zuopinName">
				发布价格:
		...
		bottom: 0;" src="../../static/image/textbj.png" alt="" />
			...
			<input style="margin-left: 10px; 10px;width: 200px;  border-bottom:solid;border-width: 1upx; " type="number"
				placeholder="发布价格" name="buyPrice" v-model="buyPrice" @input="bindbuyPrice" placeholder-class="place" />
		</view>
		<view class="zuopin">
			<p class="zuopinName">
				发布说明:
