	...
	export default {
		...
		methods: {
			...
			tox(type){
				...
				// 	}
				// 	if(type.project_type==2){
				// 		url="../../pagesA/details/details6"
				// 	}
				// 	if(type.project_type==3){
				// 		url="../../pagesA/details/details5"
				// 	}
				// 	if(type.project_type==4){
				// 		url="../../pagesA/details/details4"
				// 	}
				// 	if(type.project_type==5){
				// 		url="../../pagesA/details/details3"
				// 	}
				// 	if(type.project_type==6){
				// 		url="../../pagesA/details/details2"
				// 	}
					
				// 	uni.navigateTo({
				// 		url:`${url}?id=${type.project_id}`
				// 	})
				// }
			...
			async getxilist(){
				this.num++;
				let res=await this.get(xitonglist,{userId:uni.getStorageSync("userNum").id,pageNum:this.num});
				if(res.code==0){
